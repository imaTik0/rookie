    ...
    constructor(
        ...
        this.config = {
            ...
            mongoDb: {
                ...
                url: Deno.env.get("ROOKIE_MONGO_DB_URL") || "mongodb://localhost:27017",
            },
            qdrantVectorDb: {
                host: Deno.env.get("ROOKIE_QDRANT_HOST") || "localhost",
                port: Number.parseInt(Deno.env.get("ROOKIE_QDRANT_PORT") || "6333", 10),
            },
            openAI: {
                apiKey: Deno.env.get("ROOKIE_OPEAN_AI_KEY") || "12345689ABCDEFG",
            }
        }
    }
