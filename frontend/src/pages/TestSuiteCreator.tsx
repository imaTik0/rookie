  ...
  return (
    <div className="p-10 max-w-4xl mx-auto w-full h-full overflow-y-auto">
      <div className="mb-8">
        ...
        <p className="text-gray-600">Configure parameters for the Agentic RAG logic generation.</p>
      </div>
      ...
      <div className="bg-white border border-gray-200 p-8 rounded-2xl shadow-xl mt-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-6">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Target Project Vector</label>
              <select 
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">User Goal / Instruction</label>
            <input 
              required
              type="text" 
          ...
          <div>
            <label className="block text-sm font-medium text-gray-700 mb-2">Initial Context JSON (Mock State)</label>
            <textarea 
